...
from langsmith_cli.config import get_client
from langsmith_cli.filters import build_query_params, common_filter_options
from langsmith_cli.output import output_json, output_tree, print_runs_table
from langsmith_cli.utils import extract_run
...
def trace_export(ctx, output_dir, trace_ids, limit, project, last_n_minutes, since,
    ...
    for root in root_runs:
        ...
        filename = filename_pattern.format(trace_id=tid, name=root.name or "unknown")
