...
from langsmith_cli.output import output_json, output_table, console
from langsmith_cli.utils import resolve_dataset as _resolve_dataset
...
def dataset_generate(ctx, input_path, dataset_type, output_path, upload_name,
    ...
    """
    from langsmith_cli.generation import (
